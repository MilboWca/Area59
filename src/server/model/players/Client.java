...
public class Client extends Player {
	...
	public void initialize() {
		//synchronized (this) {
			...
			sendMessage("Welcome to 2007remake Pre-Alpha V0.2");
			//sendMessage("You can set level by ::lvl");
			//sendMessage("You can spawn by ::item [itemID] [itemAmount]");
			//sendMessage("You can get item id by ::getid [item name]");
			//sendMessage("The three commands above, will be avaliable just in pre-alpha");
			sendMessage("@red@You're online in 2007remake pre-alpha.");
			sendMessage("@red@Pre-alpha's to find glitches, and post suggestions in forums...");
			sendMessage("@red@Then our developer 'Mod Ardi' can code it, and we get official release in less time.");
			sendMessage("@blu@Thanks for your attention sir.");
...
getPA().sendFrame126("Welcome to 2007remake", 15259); 
...
getPA().sendFrame126("Set a PIN Bank to protect your pixels, lulz.", 15270);
